...
const messages: ToastMessage[] = [
  {
    ...
    url: "https://discord.gg/4Fr2HByRWs",  // ← URL corregida
...
export function DiscordToast() {
  ...
  return (
    ...
    >
      <div
        className="rounded-2xl overflow-hidden shadow-2xl shadow-black/60 border border-white/10"
        ...
        {messages.map((_, i) => (
          <button
            ...
            className={`w-1.5 h-1.5 rounded-full transition-all ${
              i === index ? "bg-[#5865F2] scale-125" : "bg-white/20 hover:bg-white/40"
            }`}
          />
        ))}
      </div>
