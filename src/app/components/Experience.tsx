...
const experiences: ExperienceItem[] = [
    ...
    description: "Actualmente me desempeño como Head Manager en KaosMC, donde me encargo de la gestión general del servidor, incluyendo la tienda, el Discord y de alguna configuración dentro de minecraft.",
    achievements: [
      "Gestión y configuración de la tienda Tebex.",
      "Administración del servidor de Discord.",
      "Gestión general del servidor y supervisión del equipo de Staff.",
    ],
    tags: ["Head Manager", "Tebex", "Discord", "Plugins", "Staff", "Gestión"],
  },
  {
    ...
    description: "Servidor donde comencé como Head Manager y ascendí al rol de Dueño, donde me encargo principalmente de la configuración general del servidor, además del desarrollo de la tienda web.",
    achievements: [
    ...
    tags: ["Gestión", "Plugins", "Discord", "Staff", "Configuraciones", "Head Manager", "Tienda", "Dueño"],
  },
  {
    ...
    description: "Entré como Administrador encargándome de la moderación y acabé asumiendo el rol de Manager, donde me encargaba un poco más de la gesitón general, además de poder ayudar con el desarrollo de dos modalidades.",
    achievements: [
  ...
  },
  {
    ...
    description: "Entré a Nautic como T-Mod mi desarrollo me llevó a ser promovido a Moderador. Después de un tiempo decidí abandonar el servidor por falta de tiempo.",
    achievements: [
      "Resolución de tickets de soporte",
      "Moderación del servidor de Discord e in-game",
    ],
    tags: ["Moderador", "Survival", "Plugins", "Staff"],
  },
  {
    ...
    description: "FluxMC era un servidor en el cual comencé mi camino en la gestión de servidores de Minecraft. Abandoné dicho servidor debido a que no le vía un futuro.",
    achievements: [
      "Gestión general de la comunidad y servidor",
      "Encargado de la gestión de la tienda web del servidor",
      "Configuración de plugins y ajustes del servidor",
    ],
    tags: ["Manager", "Staff", "Moderación"],
  },
];
