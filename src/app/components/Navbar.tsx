...
function SkillCard({ cat, index }: { cat: SkillCategory; index: number }) {
  ...
  return (
    <div
      ref={ref}
      className="bg-white rounded-2xl border border-green-100 overflow-hidden card-hover transition-all duration-500"
      style={{
        opacity: visible ? 1 : 0,
...
export function Skills() {
  ...
  return (
    <section id="conocimientos" className="min-h-screen py-20 bg-gradient-to-b from-white to-green-50/50">
